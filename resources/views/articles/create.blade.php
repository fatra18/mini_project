...
<form class="form form-horizontal" method="POST" action="{{ route('article.store') }}">
    ...
    <div class="col-md-6 mb-4">
        ...
        <fieldset class="form-group ms-4">
            <select class="form-select" id="basicSelect" name="user_id" type="text" id="users_id" value="{{ old('user_id') }}">
    ...
    <div class="form-group w-50 ms-4">
        ...
        <input type="text" class="form-control" id="basicInput" name="title" type="text"  value="{{ old('title') }}"
            placeholder="Title">
    </div>
    ...
    <div class="card-body ms-3">
        <div class="form-group mb-3 w-75">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" name="content" type="text"  value="{{ old('content') }}"
                rows="3"></textarea>
        </div>
    </div>
